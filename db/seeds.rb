...
Prescription.create(refills: 1, fill_duration: 1, start_date: Date.today, end_date: ((Date.today + 1) - 1), doctor_id: 1, pharmacy_id: 1, user_id: 2, drug_id: 9, dose_size: '100mg')
Prescription.create(refills: 3, fill_duration: 2, start_date: Date.today, end_date: ((Date.today + 2) - 1), doctor_id: 2, pharmacy_id: 2, user_id: 2, drug_id: 10, dose_size: '50mg')
Prescription.create(refills: 0, fill_duration: 9, start_date: Date.today, end_date: ((Date.today + 9) - 1), doctor_id: 3, pharmacy_id: 1, user_id: 2, drug_id: 11, dose_size: '500mg')
Prescription.create(refills: 7, fill_duration: 7, start_date: Date.today, end_date: ((Date.today + 7) - 1), doctor_id: 4, pharmacy_id: 2, user_id: 2, drug_id: 12, dose_size: '200mg')
Prescription.create(refills: 0, fill_duration: 1, start_date: Date.today, end_date: ((Date.today + 1) - 1), doctor_id: 5, pharmacy_id: 1, user_id: 2, drug_id: 13, dose_size: '75mg')
Prescription.create(refills: 3, fill_duration: 4, start_date: Date.today, end_date: ((Date.today + 1) - 1), doctor_id: 1, pharmacy_id: 2, user_id: 2, drug_id: 14, dose_size: '300mg')
Prescription.create(refills: 3, fill_duration: 3, start_date: Date.today, end_date: ((Date.today + 1) - 1), doctor_id: 2, pharmacy_id: 1, user_id: 2, drug_id: 15, dose_size: '10mg')
Prescription.create(refills: 4, fill_duration: 1, start_date: Date.today, end_date: ((Date.today + 1) - 1), doctor_id: 3, pharmacy_id: 2, user_id: 2, drug_id: 16, dose_size: '900mg')
