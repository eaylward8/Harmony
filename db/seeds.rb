...
Prescription.create(refills: 7, fill_duration: 7, start_date: Date.today, end_date: ((Date.today + 7) - 1), doctor_id: 4, pharmacy_id: 2, user_id: 1, drug_id: 4, dose_size: '200mg')
...
Prescription.create(refills: 3, fill_duration: 4, start_date: Date.today, end_date: ((Date.today + 1) - 1), doctor_id: 1, pharmacy_id: 2, user_id: 1, drug_id: 6, dose_size: '300mg')
Prescription.create(refills: 3, fill_duration: 3, start_date: Date.today, end_date: ((Date.today + 1) - 1), doctor_id: 2, pharmacy_id: 1, user_id: 1, drug_id: 7, dose_size: '10mg')
Prescription.create(refills: 4, fill_duration: 1, start_date: Date.today, end_date: ((Date.today + 1) - 1), doctor_id: 3, pharmacy_id: 2, user_id: 1, drug_id: 8, dose_size: '900mg')
